...
static const struct bo_json_obj_attr_desc wrong_bool_or_null_flags_field_type_attrs[] = {
	BO_JSON_OBJECT_ATTR_BOOL_OR_NULL(struct wrong_bool_flags_field_type, value, value_exist,
					 value_flags),
};
...
static const struct bo_json_obj_attr_desc wrong_int64_or_null_flags_field_type_attrs[] = {
	BO_JSON_OBJECT_ATTR_INT64_OR_NULL(struct wrong_int64_flags_field_type, value, value_exist,
					  value_flags),
};
...
static const struct bo_json_obj_attr_desc wrong_double_or_null_flags_field_type_attrs[] = {
	BO_JSON_OBJECT_ATTR_DOUBLE_OR_NULL(struct wrong_double_flags_field_type, value, value_exist,
					   value_flags),
};
#elif defined(TEST_CSTR_ARRAY_POINTER_TYPE)
static const struct bo_json_obj_attr_desc wrong_cstr_pointer_type_attrs[] = {
	BO_JSON_OBJECT_ATTR_CSTR_ARRAY(struct wrong_cstr_pointer_type, value, value_exist),
};
...
static const struct bo_json_obj_attr_desc wrong_cstr_array_or_null_pointer_type_attrs[] = {
	BO_JSON_OBJECT_ATTR_CSTR_ARRAY_OR_NULL(struct wrong_cstr_flags_field_type, value,
...
static const struct bo_json_obj_attr_desc nested_object_attrs[] = {
	BO_JSON_OBJECT_ATTR_INT(struct nested_object, id, id_exist),
};
static const struct bo_json_obj_attr_desc wrong_object_or_null_flags_field_type_attrs[] = {
	BO_JSON_OBJECT_ATTR_OBJECT_OR_NULL(struct wrong_object_flags_field_type, value,
...
static const struct bo_json_obj_attr_desc wrong_count_field_type_attrs[] = {
	BO_JSON_OBJECT_ATTR_ARRAY(struct wrong_count_field_type, values, &bo_json_int_desc, 4,
...
static const struct bo_json_obj_attr_desc wrong_array_or_null_count_field_type_attrs[] = {
	BO_JSON_OBJECT_ATTR_ARRAY_OR_NULL(struct wrong_count_field_type, values, &bo_json_int_desc,
					  4, values_exist, values_count_ok, values_flags),
};
...
static const struct bo_json_obj_attr_desc wrong_typed_object_member_type_attrs[] = {
	BO_JSON_OBJECT_ATTR_OBJECT_TYPED(struct wrong_typed_object_member_type, value,
					 struct nested_object, nested_object_attrs, value_exist),
};
...
static const struct bo_json_obj_attr_desc wrong_typed_object_or_null_member_type_attrs[] = {
	BO_JSON_OBJECT_ATTR_OBJECT_OR_NULL_TYPED(struct wrong_typed_object_member_type, value,
...
static const struct bo_json_obj_attr_desc wrong_typed_array_element_type_attrs[] = {
	BO_JSON_OBJECT_ATTR_ARRAY_TYPED(struct wrong_typed_array_element_type, values, int,
...
static const struct bo_json_obj_attr_desc wrong_typed_array_or_null_element_type_attrs[] = {
	BO_JSON_OBJECT_ATTR_ARRAY_OR_NULL_TYPED(struct wrong_typed_array_element_type, values, int,
						&bo_json_int_desc, 4, values_exist, values_count,
						values_flags),
};
